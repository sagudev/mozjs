...
use crate::jsapi::JS::RegExpFlags;
use crate::jsapi::{already_AddRefed, jsid, Value};
use crate::jsapi::{AutoGCRooter, AutoGCRooterKind};
use crate::jsapi::{BuildStackString, CaptureCurrentStack, StackFormat};
use crate::jsapi::{Evaluate2, HandleValueArray, Heap, StencilRelease};
use crate::jsapi::{InitSelfHostedCode, InstantiationStorage, IsWindowSlow, OffThreadToken};
use crate::jsapi::{JSAutoRealm, JS_SetGCParameter, JS_SetNativeStackQuota, JS_WrapValue};
use crate::jsapi::{JSClass, JSClassOps, JSContext, Realm, JSCLASS_RESERVED_SLOTS_SHIFT};
use crate::jsapi::{JSErrorReport, JSFunction, JSFunctionSpec, JSGCParamKey};
use crate::jsapi::{JSObject, JSPropertySpec, JSRuntime, JSScript};
use crate::jsapi::{JSString, JSTracer, Object, PersistentRootedIdVector};
...
use crate::jsapi::{PersistentRootedObjectVector, ReadOnlyCompileOptions, Rooted, RootingContext};
use crate::jsapi::{SetWarningReporter, SourceText, Symbol, ToBooleanSlow};
...
pub mod wrappers {
    ...
    use crate::jsapi::HandleIdVector;
