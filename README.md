...
Mozjs-sys crate contains bindings are to the raw SpiderMonkey API, higher-level bindings
are in the [mozjs directory](https://github.com/servo/mozjs/tree/master/mozjs).
